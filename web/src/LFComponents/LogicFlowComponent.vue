<!-- <template>
  <div class="logicflow-container" ref="logicflowContainer"></div>
  <HttpRequestDrawer
    :visible.sync="drawerVisible"
    :requestData.sync="selectedNodeData"
  />
</template>
...
// import '@logicflow/core/dist/style/index.css'; // 这个是旧的 dist目录里没有这个css
import '@logicflow/core/lib/style/index.css'; // 这个是新的
// import HttpRequestDrawer from './HttpRequestDrawer.vue';
import { onMounted,ref } from 'vue';

class HttpRequestNodeModel extends BaseNodeModel {
  initNodeData(data) {
...
const  name = 'LogicFlowComponent';
 
      const drawerVisible = false;
      const selectedNodeData = null;
 onMounted(()=> {
    try{
    ...
    lf.extension.dndPanel.setPatternItems([
      {
        type: 'execute-http-request',
        name: 'HTTP Request',
        icon: '/assets/HTTP请求.png',
        label: "http",
        properties: {
